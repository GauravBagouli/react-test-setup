...
const HipaaSignup = () => {
    ...
    const handleAgree = () => {
        ...
        // Submit form logic (you can replace this with an API call)
    }
    ...
    return (
        <div className="row justify-content-center" style={{ minHeight: '102vh' }}>
            ...
            <div className="row align-items-center justify-content-center flex-column col-12 col-md-8 py-4 pe-0">
                ...
                <div className="logo login-logo mx-auto" style={{ backgroundImage: `url(https://cdn.assets.pluto-service.com/patient-web-clients/pluto/nav.png)`,}}></div>
                ...
                <div className="w-100 w-md-75 mx-auto my-4 px-5 px-md-2">
                    ...
                    <div id="hipaa-container" className="border-opacity-0 h-auto ql-container ql-snow ql-disabled"> 
                        <div dangerouslySetInnerHTML={{ __html: hipaaAuth }} />
                    </div>

                    <h3 className="mt-4 fw-semibold">Your signature below</h3>
                    <canvas id="signature-pad" className="signature-pad bg-secondary-subtle w-100" height="80">


                    </canvas>

                    <form id="signup-hipaa-form" method="post" action="/signup/hipaa" onSubmit={handleSubmit}>
                        <input type="hidden" id="signature_string" name="signature_string" value={signature} />
                        <div className="d-flex pb-5">
                            <button type="button" class="btn rounded-pill btn-outline-primary d-block w-100 mx-2">Cancel</button>
                            <button type="submit" class="btn rounded-pill btn-primary d-blcok w-100 mx-2">I agree to terms</button>
                        </div>
                    </form>
                </div>
            </div>
